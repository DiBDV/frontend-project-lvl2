...
test('gendiff flat file', () => {
  expect(gendiff(getFixturePath('file1.json'), getFixturePath('file2.json'), 'stylish')).toBe(readFile('expected_01.txt'));
  expect(gendiff(getFixturePath('file1.yaml'), getFixturePath('file2.yaml'), 'stylish')).toBe(readFile('expected_01.txt'));
});
